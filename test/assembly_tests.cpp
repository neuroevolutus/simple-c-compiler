...
TEST_CASE("assembly generator works correctly")
{
  ...
  SECTION("Chapter 3: a program with binary operators is assembled correctly")
  {
    ...
    REQUIRE(assembly->prettyPrint() ==
      "Program:\n"
      "  Function: main\n"
      "    Instruction: Mov (ImmediateValue: 2), (PseudoRegister: main.2)\n"
      "    Instruction: Binary (Multiply (ImmediateValue: 10), (PseudoRegister: main.2))\n"
      "    Instruction: Mov (PseudoRegister: main.2), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Idiv (ImmediateValue: 7)\n"
      "    Instruction: Mov (Register: %dx), (PseudoRegister: main.3)\n"
      "    Instruction: Mov (ImmediateValue: 5), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Idiv (ImmediateValue: 2)\n"
      "    Instruction: Mov (Register: %ax), (PseudoRegister: main.4)\n"
      "    Instruction: Mov (PseudoRegister: main.4), (PseudoRegister: main.5)\n"
      "    Instruction: Binary (RightShift (ImmediateValue: 3), (PseudoRegister: main.5))\n"
      "    Instruction: Mov (PseudoRegister: main.3), (PseudoRegister: main.6)\n"
      "    Instruction: Binary (BitwiseAnd (PseudoRegister: main.5), (PseudoRegister: main.6))\n"
      "    Instruction: Mov (PseudoRegister: main.6), (Register: %ax)\n"
      "    Instruction: Ret\n"
    );
    auto [last_offset, _, cleaned_assembly]{ assembly->replacePseudoRegisters(
    ) };
    REQUIRE(cleaned_assembly->prettyPrint() ==
      ...
      "    Instruction: Mov (StackOffset: -4), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Idiv (ImmediateValue: 7)\n"
      "    Instruction: Mov (Register: %dx), (StackOffset: -8)\n"
      "    Instruction: Mov (ImmediateValue: 5), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Idiv (ImmediateValue: 2)\n"
      "    Instruction: Mov (Register: %ax), (StackOffset: -12)\n"
      "    Instruction: Mov (StackOffset: -12), (StackOffset: -16)\n"
      "    Instruction: Binary (RightShift (ImmediateValue: 3), (StackOffset: -16))\n"
      "    Instruction: Mov (StackOffset: -8), (StackOffset: -20)\n"
      "    Instruction: Binary (BitwiseAnd (StackOffset: -16), (StackOffset: -20))\n"
      "    Instruction: Mov (StackOffset: -20), (Register: %ax)\n"
      "    Instruction: Ret\n"
    );
    auto fixed_assembly{ cleaned_assembly->fixUp(-last_offset) };
    REQUIRE(fixed_assembly->prettyPrint() ==
      ...
      "    Instruction: Mov (ImmediateValue: 2), (StackOffset: -4)\n"
      "    Instruction: Mov (StackOffset: -4), (Register: %r11)\n"
      "    Instruction: Binary (Multiply (ImmediateValue: 10), (Register: %r11))\n"
      "    Instruction: Mov (Register: %r11), (StackOffset: -4)\n"
      "    Instruction: Mov (StackOffset: -4), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Mov (ImmediateValue: 7), (Register: %r10)\n"
      "    Instruction: Idiv (Register: %r10)\n"
      "    Instruction: Mov (Register: %dx), (StackOffset: -8)\n"
      "    Instruction: Mov (ImmediateValue: 5), (Register: %ax)\n"
      "    Instruction: Cdq\n"
      "    Instruction: Mov (ImmediateValue: 2), (Register: %r10)\n"
      "    Instruction: Idiv (Register: %r10)\n"
      "    Instruction: Mov (Register: %ax), (StackOffset: -12)\n"
      "    Instruction: Mov (StackOffset: -12), (Register: %r10)\n"
      "    Instruction: Mov (Register: %r10), (StackOffset: -16)\n"
      "    Instruction: Binary (RightShift (ImmediateValue: 3), (StackOffset: -16))\n"
      "    Instruction: Mov (StackOffset: -8), (Register: %r10)\n"
      "    Instruction: Mov (Register: %r10), (StackOffset: -20)\n"
      "    Instruction: Mov (StackOffset: -16), (Register: %r10)\n"
      "    Instruction: Binary (BitwiseAnd (Register: %r10), (StackOffset: -20))\n"
      "    Instruction: Mov (StackOffset: -20), (Register: %ax)\n"
      "    Instruction: Ret\n"
    );
  }
